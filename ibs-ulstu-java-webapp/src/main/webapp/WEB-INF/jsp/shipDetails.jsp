...
<head>
	...
	<link rel="stylesheet" href="resources/css/shipDetails.css">
</head>
<body>
    ...
    <div class="section" style="clear: both; margin-top: 5px;">
        <div>
    		<div><span>Судно с опасным грузом</span></div>
    	</div>
    	<div>
    		<div><span>Судно имет высокий целевой фактор</span></div>
    	</div>

    	<div>
    		<div><span>Судно с сигналом SSAS</span></div>
    	</div>
    </div>
    <br>
    <div class="section">
		...
		<table class="table">
			<tbody>
				...
				<tr>
                    <td>Флаг</td>
                    <td>Российская Федерация / RUS</td>
				</tr>
			</tbody>
		</table>
	</div>
